...
namespace {
struct qt_meta_stringdata_ItemDetailScreen_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ItemDetailScreen_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ItemDetailScreen_t qt_meta_stringdata_ItemDetailScreen = {
    {
        QT_MOC_LITERAL(0, 16),  // "ItemDetailScreen"
        QT_MOC_LITERAL(17, 11),  // "exitRequest"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 11),  // "loanRequest"
        QT_MOC_LITERAL(42, 5),  // "Item*"
        QT_MOC_LITERAL(48, 4),  // "item"
        QT_MOC_LITERAL(53, 11),  // "keepRequest"
        QT_MOC_LITERAL(65, 19),  // "onExitButtonClicked"
        QT_MOC_LITERAL(85, 19),  // "onLoanButtonClicked"
        QT_MOC_LITERAL(105, 19)   // "onKeepButtonClicked"
    },
    "ItemDetailScreen",
    "exitRequest",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ItemDetailScreen[] = {
...
Q_CONSTINIT const QMetaObject ItemDetailScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_ItemDetailScreen.offsetsAndSizes,
    qt_meta_data_ItemDetailScreen,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ItemDetailScreen_t,
        // Q_OBJECT / Q_GADGET
...
void ItemDetailScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ItemDetailScreen::*)();
            if (_t _q_method = &ItemDetailScreen::exitRequest; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ItemDetailScreen::*)(Item * );
            if (_t _q_method = &ItemDetailScreen::loanRequest; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ItemDetailScreen::*)(Item * );
            if (_t _q_method = &ItemDetailScreen::keepRequest; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *ItemDetailScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ItemDetailScreen.stringdata0))
