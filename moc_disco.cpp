...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Disco_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Disco_t qt_meta_stringdata_Disco = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Disco[] = {
...
Q_CONSTINIT const QMetaObject Disco::staticMetaObject = { {
    ...
    qt_meta_stringdata_Disco.offsetsAndSizes,
    qt_meta_data_Disco,
    qt_static_metacall,
    nullptr,
