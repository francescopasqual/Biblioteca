...
namespace {
struct qt_meta_stringdata_Fisico_t {
    uint offsetsAndSizes[2];
    char stringdata0[7];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Fisico_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Fisico_t qt_meta_stringdata_Fisico = {
    {
        QT_MOC_LITERAL(0, 6)   // "Fisico"
    },
    "Fisico"
};
...
Q_CONSTINIT static const uint qt_meta_data_Fisico[] = {
...
Q_CONSTINIT const QMetaObject Fisico::staticMetaObject = { {
    ...
    qt_meta_stringdata_Fisico.offsetsAndSizes,
    qt_meta_data_Fisico,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Fisico_t,
        // Q_OBJECT / Q_GADGET
...
void *Fisico::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Fisico.stringdata0))
