...
namespace {
struct qt_meta_stringdata_ItemListScreen_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ItemListScreen_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ItemListScreen_t qt_meta_stringdata_ItemListScreen = {
    {
        QT_MOC_LITERAL(0, 14),  // "ItemListScreen"
        QT_MOC_LITERAL(15, 12),  // "itemSelected"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 5),  // "Item*"
        QT_MOC_LITERAL(35, 12),  // "selectedItem"
        QT_MOC_LITERAL(48, 13),  // "backRequested"
        QT_MOC_LITERAL(62, 13),  // "onItemClicked"
        QT_MOC_LITERAL(76, 17),  // "QTableWidgetItem*"
        QT_MOC_LITERAL(94, 4),  // "item"
        QT_MOC_LITERAL(99, 19)   // "onBackButtonClicked"
    },
    "ItemListScreen",
    "itemSelected",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ItemListScreen[] = {
...
Q_CONSTINIT const QMetaObject ItemListScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_ItemListScreen.offsetsAndSizes,
    qt_meta_data_ItemListScreen,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ItemListScreen_t,
        // Q_OBJECT / Q_GADGET
...
void ItemListScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ItemListScreen::*)(Item * );
            if (_t _q_method = &ItemListScreen::itemSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ItemListScreen::*)();
            if (_t _q_method = &ItemListScreen::backRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *ItemListScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ItemListScreen.stringdata0))
