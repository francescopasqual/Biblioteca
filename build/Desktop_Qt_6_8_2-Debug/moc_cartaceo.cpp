...
namespace {
struct qt_meta_tag_ZN8CartaceoE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8CartaceoE = QtMocHelpers::stringData(
    "Cartaceo"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8CartaceoE[] = {
...
Q_CONSTINIT const QMetaObject Cartaceo::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8CartaceoE.offsetsAndSizes,
    qt_meta_data_ZN8CartaceoE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8CartaceoE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<Cartaceo *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *Cartaceo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8CartaceoE.stringdata0))
