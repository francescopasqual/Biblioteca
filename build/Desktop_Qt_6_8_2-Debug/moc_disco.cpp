...
static constexpr auto qt_meta_stringdata_ZN5DiscoE = QtMocHelpers::stringData(
    "Disco"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5DiscoE[] = {
...
Q_CONSTINIT const QMetaObject Disco::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5DiscoE.offsetsAndSizes,
    qt_meta_data_ZN5DiscoE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5DiscoE_t,
        // Q_OBJECT / Q_GADGET
...
void *Disco::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5DiscoE.stringdata0))
