...
namespace {
struct qt_meta_tag_ZN4ItemE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN4ItemE = QtMocHelpers::stringData(
    "Item"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4ItemE[] = {
...
Q_CONSTINIT const QMetaObject Item::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4ItemE.offsetsAndSizes,
    qt_meta_data_ZN4ItemE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4ItemE_t,
        // Q_OBJECT / Q_GADGET
...
void *Item::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4ItemE.stringdata0))
